...
@Configurable
@Autonomous(name = "Red Big Triangle (12 Artifacts)")
public class bigTriangleRed12artifact extends LiveAutoBase {
    ...
    public void drawOnlyCurrent() {
        try {
            org.firstinspires.ftc.teamcode.xcentrics.OpModes.Auto.comp.red.Drawing.drawRobot(robot.follower.getPose());
            org.firstinspires.ftc.teamcode.xcentrics.OpModes.Auto.comp.red.Drawing.drawPath(robot.follower.getCurrentPath(),new Style("","#3F51B5",0.75));
            org.firstinspires.ftc.teamcode.xcentrics.OpModes.Auto.comp.red.Drawing.sendPacket();
        } catch (Exception e) {
