...
public class Small9Red extends LiveAutoBase {
    ...
    public void on_init() {
        ...
        p1 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(87.289, 8.514),
                                new Pose(81.966, 32.385),
                                new Pose(94.837, 34.256)
                        )
        ...
        p6 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(132.097, 21.419),
                                new Pose(130.468, 18.806),
                                new Pose(133.290, 11.097)
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(336), Math.toRadians(-80))
        ...
        p7 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(133.290, 11.097),
                                new Pose(113.484, 15.823),
                                new Pose(87.290, 8.419)
                        )
        ...
        p8 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(87.290, 8.419),
                                new Pose(96.774, 16.081),
                                new Pose(132.452, 12.968)
                        )
