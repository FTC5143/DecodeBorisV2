...
public class big12blue extends LiveAutoBase {
    ...
    private final Pose startPose = new Pose(27.5,131.6,r(144)),
                       ...
                       rotatePose = new Pose(44,85,r(180)),
                       pickup1 = new Pose(15,85,r(180)),
                       scorePose = new Pose(58.5,85,r(180)),
                       pickup2 = new Pose(9.3,59,r(180)),
                       emptyGatePose = new Pose(16.5,70,r(90)),
                       pickup3 = new Pose(9,36,r(180)),
                       parkPose = new Pose(47,76,r(180));

    //control points for lines
    private final Pose p21 = new Pose(56.6,50.8),
                       p22 = new Pose(6,60.3),
                       p23 = new Pose(37.2,59.1),
